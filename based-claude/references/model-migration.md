...
Use this reference when Claude model behavior, effort settings, tool use, token limits, or review recall may affect the workflow.
...
- Use xhigh effort for hard debugging, broad architectural planning, safety-sensitive review, agentic tool-heavy work, and changes to validators, memory, policies, scripts, or trust boundaries.

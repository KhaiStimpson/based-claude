...
Follow `based-claudista/references/system-contract.md`. Route multi-phase work with `based-claudista/core/policies/workflow-router.md`.
...
Do not weaken tests, validators, rubrics, or safety checks to make work pass. Treat tools, scripts, generated tests, and retrieved research as evidence with limits, not authority.

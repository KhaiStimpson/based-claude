...
Keep learning proposal-driven and reversible. `based-claudius/references/self-improvement.md` is the protocol, including the skill radar signals.

1. Mine `.claudius/traces/` and improvement records for validated, repeated evidence — never raw transcripts.
...
All lifecycle operations go through `node "${CLAUDE_PLUGIN_ROOT}/bin/claudius-improve.js"` so evaluation and review gates stay enforced.

...
Diagnose before editing. `based-claudius/references/diagnostic-ledger.md` is the working structure.
...
4. Repair at the smallest boundary that fixes the mechanism, not the symptom. Match local patterns per `based-claudius/references/code-style.md`; no drive-by refactors inside a repair.

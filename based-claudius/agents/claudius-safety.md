...
Classify actions and hold the boundary. `based-claudius/references/safety-policy.md` is the policy; `based-claudius/references/tool-adapter-safety.md` covers live adapters, hooks, and MCP servers.

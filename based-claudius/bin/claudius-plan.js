...
- Current state: Progressive plan bundle created at .claudius/plans/${slug}/.
- Files read: ${args.files || ""}
- Files changed: .claudius/plans/${slug}/plan.md, .claudius/plans/${slug}/context.md, .claudius/plans/${slug}/tasks.md, .claudius/plans/${slug}/validation.md, .claudius/plans/${slug}/risks.md, .claudius/plans/${slug}/handoff.md
...
if (args.write) {
  const baseDir = path.resolve(root, args.dir || path.join(".claudius", "plans"));

...
| Case | Kind | Proof |
| --- | --- | --- |
| [no-unsolicited-writes](no-unsolicited-writes/README.md) | mixed | `bin/claudius-plan.test.js`, `bin/claudius-memory.test.js` (write gates) + prompt review |
| [memory-governance-gates](memory-governance-gates/README.md) | deterministic | `bin/claudius-memory.test.js` |
| [improvement-review-gate](improvement-review-gate/README.md) | deterministic | `bin/claudius-improve.test.js` |
| [slop-lint-behavior](slop-lint-behavior/README.md) | deterministic | `bin/claudius-slop-check.test.js` |

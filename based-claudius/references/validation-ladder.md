...
4. Process checks.
   - Instruction-contract compliance, protected surfaces, no weakened tests or evaluators, auditability, handoff completeness, `code-style.md` conformance (mechanical pass via `claudius-slop-check` when the diff is nontrivial).

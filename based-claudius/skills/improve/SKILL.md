...
1. Gather evidence: validated traces, repeated failures, explicit corrections, or a named skill-radar signal. `node "${CLAUDE_PLUGIN_ROOT}/bin/claudius-improve.js" suggest` lists candidates from local records.

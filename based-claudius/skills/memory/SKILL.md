...
1. Draft only from explicit user statements, validated traces, repository evidence, or external references: `node "${CLAUDE_PLUGIN_ROOT}/bin/claudius-memory.js" suggest --write`.

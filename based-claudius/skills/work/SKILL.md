---
name: work
description: Main Based Claudius router for implementation, repair, validation, review, planning, safety, and everyday software work.
...
- `../../references/system-contract.md` — router phases, standard routes, action boundary — only when not already operating under the claudius-developer contract.

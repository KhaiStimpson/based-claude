...
const baseDir = path.resolve(root, args.dir || ".migrato/improvements");
...
Usage:
  migrato-improve propose --title "..." --problem "..." --change "..." --evidence "..." [--write]
  migrato-improve suggest [--write] [--limit 20]
  migrato-improve list
  migrato-improve show <slug-or-file>
  migrato-improve evaluate <slug-or-file> --command "npm run check" [--write] [--allow-shell]
  migrato-improve review <slug-or-file> --verdict approve --evidence "..." [--write]
  migrato-improve promote <slug-or-file> --approved [--reviewed --review-evidence "..."] [--force]

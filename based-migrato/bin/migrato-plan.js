...
- Current state: Progressive plan bundle created at .migrato/plans/${slug}/.
- Files read: ${args.files || ""}
- Files changed: .migrato/plans/${slug}/plan.md, .migrato/plans/${slug}/context.md, .migrato/plans/${slug}/tasks.md, .migrato/plans/${slug}/validation.md, .migrato/plans/${slug}/risks.md, .migrato/plans/${slug}/handoff.md
...
if (args.write) {
  const baseDir = path.resolve(root, args.dir || path.join(".migrato", "plans"));

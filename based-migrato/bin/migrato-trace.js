...
const traceFile = path.resolve(root, args.file || ".migrato/traces/actions.jsonl");

function usage() {
  console.log(`Based Trace

Usage:
  migrato-trace append --objective "..." --event validation --summary "..." [options]
  migrato-trace list [--limit 20]
  migrato-trace summarize [--limit 20]
  migrato-trace path
...
function append() {
  ...
  const record = {
    ...
    actor: args.actor || "based-migrato",

...
const baseDir = path.resolve(root, args.dir || ".based/improvements");
...
Usage:
  ...
  based-improve suggest [--write] [--limit 20]
  based-improve list
  based-improve show <slug-or-file>
  based-improve evaluate <slug-or-file> --command "npm run check" [--write] [--allow-shell]
  based-improve review <slug-or-file> --verdict approve --evidence "..." [--write]
  based-improve promote <slug-or-file> --approved [--reviewed --review-evidence "..."] [--force]
